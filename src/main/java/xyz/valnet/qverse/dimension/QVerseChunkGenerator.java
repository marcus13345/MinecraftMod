...
public class QVerseChunkGenerator extends NoiseChunkGenerator<QVerseGenerationSettings> {
	...
	public QVerseChunkGenerator(final IWorld worldIn, final BiomeProvider biomeProviderIn,
			final QVerseGenerationSettings generationSettingsIn) {
